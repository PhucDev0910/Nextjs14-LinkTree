...
export default function PageButtonsForm({ user, page }) {
  // Kiểm tra nếu page.buttons không tồn tại thì đặt mặc định là một đối tượng rỗng
  const pageButtons = page?.buttons || {};

  // Kiểm tra nếu không có nút thì trả về mảng rỗng
  ...
  // Lọc các nút chưa được thêm vào profile
            ...
            <div key={b.key} className="mb-4 md:flex items-center">
              ...
              <div className="grow flex">
                <input
                  ...
                  name={b.key}
                  defaultValue={pageButtons[b.key]} // Sử dụng pageButtons đã kiểm tra
                  type="text"
